		...
		tree.setModel(new DefaultTreeModel(new DefaultMutableTreeNode(
...

			{
				...
				node_1.add(new DefaultMutableTreeNode(
						"Import Match List from MatchMaker.exe output implemented."));
				add(node_1);
				node_1 = new DefaultMutableTreeNode("V 1.3.1");
				node_1.add(new DefaultMutableTreeNode(
						"Converted from complicated Event Handling to simply passing parent references."));
				node_1.add(new DefaultMutableTreeNode(
						"Implemented SQL Lite DB."));
				add(node_1);
				node_1 = new DefaultMutableTreeNode("V 1.2.3a");
				node_1.add(new DefaultMutableTreeNode(
						"Implemented the editing functions required to edit matches for the listing"));
				node_1.add(new DefaultMutableTreeNode(
						"Extended the implementation of real-time calculations using Event Handling."));
				add(node_1);
				node_1 = new DefaultMutableTreeNode("V 1.2.2");
				node_1.add(new DefaultMutableTreeNode(
						"Started the process required to import matches"));
				add(node_1);
				node_1 = new DefaultMutableTreeNode("V 1.2.1");
				node_1.add(new DefaultMutableTreeNode(
						"Fixed non-calc issue from pyramid block."));
				add(node_1);
			}
		}));
